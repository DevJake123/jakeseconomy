...
public class MarketManager {
     ...
     * */
    public void setPrice(String itemId, double basePrice, double marketDepthOverride, String category) {
        ...
        prices.categories.computeIfAbsent(category, k -> new java.util.LinkedHashMap<>())
                .put(itemId, new JakesEconomyPriceConfig.ItemPrice(basePrice, marketDepthOverride));
